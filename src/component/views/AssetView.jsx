  ...
  return (
    <div className="flex flex-col h-full bg-black text-white overflow-hidden pb-32 relative z-10">
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-6 sm:space-y-8 animate-in slide-in-from-left-4">
        ...
        {/* Tổng tài sản */}
        <div className="bg-linear-to-br from-zinc-800 to-black rounded-3xl sm:rounded-[2.5rem] p-6 sm:p-8 border border-zinc-700 shadow-2xl relative">
        ...
        <div>
          ...
          {isAccountFormVisible ? (
            <div className="bg-zinc-900 rounded-2xl sm:rounded-3xl p-4 sm:p-5 border border-zinc-700 shadow-xl animate-in fade-in">
              ...
              <div className="space-y-2.5 sm:space-y-3">
                ...
                <div className="bg-black p-2.5 sm:p-3 rounded-xl border border-zinc-800 mt-2">
                  <label className="text-[10px] sm:text-[11px] uppercase font-bold text-zinc-500 mb-1.5 sm:mb-2 flex items-center gap-1">
                    <Zap size={12} className="text-yellow-500 sm:w-3.5 sm:h-3.5" /> Ví Dự Phòng
                  </label>
        ...
        <div>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            {investmentTags.map((tag, idx) => {
              ...
              return (
                <div key={tag.id} className="bg-[#1C1C1E] rounded-2xl sm:rounded-4xl border border-zinc-800 shadow-xl relative overflow-hidden transition-all duration-300">
